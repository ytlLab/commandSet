...
專案內路徑： 如果圖片在你的 Repository 裡，使用相對路徑： ![說明](./images/screenshot.png)</br>
直接上傳： 在 GitHub 的 Issue 或 Pull Request 留言框中直接「拖放」圖片，它會自動生成一個以 https://user-images.githubusercontent.com/... 開頭的連結，你可以複製這個連結貼到 .md 檔裡。</br>
